        ...
        {items.length > 0 && (
          <div className="border-t border-light-rose p-6 space-y-4 animate-item">
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className="text-dark-brown font-medium">₹{totalPrice.toLocaleString('en-IN')}</span>
            </div>
            <div className="flex justify-between text-sm">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-serif text-2xl text-coral">₹{totalPrice.toLocaleString('en-IN')}</span>
            </div>
